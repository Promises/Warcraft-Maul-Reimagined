...
import {Group, Trigger, MapPlayer,Unit} from "w3ts";
...
export class WorldMap {
    ...
    constructor(game: WarcraftMaul) {
        ...
        this.gameTimeTrigger = Trigger.create();
        this.gameTimeTrigger.registerTimerEvent(1.00, true);
    ...
    private setupWorldCreatures(): void {
        ...
        this.ship = new Ship(new Unit(MapPlayer.fromIndex(COLOUR.NAVY)! , FourCC('n05G'), 63.0, -5343.5, 0.000), this);
    ...
    public createDummyCreeps(): void {
        ...
        const passivePlayer = MapPlayer.fromIndex(PLAYER_NEUTRAL_PASSIVE);
        if(!passivePlayer) {
            return;
        }

        dummyCreeps.push(new Unit(passivePlayer, FourCC('u006'), 1664.0, 3072.0, 270.0));
        dummyCreeps.push(new Unit(passivePlayer, FourCC('hC04'), 1792.0, 3072.0, 270.0));
        dummyCreeps.push(new Unit(passivePlayer, FourCC('eC05'), 1920.0, 3072.0, 270.0));
        dummyCreeps.push(new Unit(passivePlayer, FourCC('hC16'), 2048.0, 3072.0, 270.0));
        dummyCreeps.push(new Unit(passivePlayer, FourCC('nC17'), 2176.0, 3072.0, 270.0));
        dummyCreeps.push(new Unit(passivePlayer, FourCC('nC29'), 1664.0, 2944.0, 270.0));
        dummyCreeps.push(new Unit(passivePlayer, FourCC('o01C'), 1792.0, 2944.0, 270.0));
        dummyCreeps.push(new Unit(passivePlayer, FourCC('nC30'), 1920.0, 2944.0, 270.0));
        dummyCreeps.push(new Unit(passivePlayer, FourCC('oC31'), 2048.0, 2944.0, 270.0));
        dummyCreeps.push(new Unit(passivePlayer, FourCC('nC33'), 2176.0, 2944.0, 270.0));
        dummyCreeps.push(new Unit(passivePlayer, FourCC('n008'), 1664.0, 2816.0, 270.0));
        dummyCreeps.push(new Unit(passivePlayer, FourCC('eC38'), 1792.0, 2816.0, 270.0));
        dummyCreeps.push(new Unit(passivePlayer, FourCC('nC39'), 1920.0, 2816.0, 270.0));
        dummyCreeps.push(new Unit(passivePlayer, FourCC('nC40'), 2048.0, 2816.0, 270.0));
        dummyCreeps.push(new Unit(passivePlayer, FourCC('nC41'), 2176.0, 2816.0, 270.0));
        dummyCreeps.push(new Unit(passivePlayer, FourCC('nC42'), 1664.0, 2688.0, 270.0));
        dummyCreeps.push(new Unit(passivePlayer, FourCC('uC43'), 1792.0, 2688.0, 270.0));
        dummyCreeps.push(new Unit(passivePlayer, FourCC('hC44'), 1920.0, 2688.0, 270.0));
        dummyCreeps.push(new Unit(passivePlayer, FourCC('uC45'), 2048.0, 2688.0, 270.0));
        dummyCreeps.push(new Unit(passivePlayer, FourCC('n004'), 2176.0, 2688.0, 270.0));
        dummyCreeps.push(new Unit(passivePlayer, FourCC('hC48'), 1664.0, 2560.0, 270.0));
        dummyCreeps.push(new Unit(passivePlayer, FourCC('oC47'), 1792.0, 2560.0, 270.0));
        dummyCreeps.push(new Unit(passivePlayer, FourCC('nC49'), 1920.0, 2560.0, 270.0));
        dummyCreeps.push(new Unit(passivePlayer, FourCC('nC50'), 2048.0, 2560.0, 270.0));
        dummyCreeps.push(new Unit(passivePlayer, FourCC('nC51'), 2176.0, 2560.0, 270.0));
        dummyCreeps.push(new Unit(passivePlayer, FourCC('nC69'), 1664.0, 2432.0, 270.0));
        dummyCreeps.push(new Unit(passivePlayer, FourCC('eC52'), 1792.0, 2432.0, 270.0));
        dummyCreeps.push(new Unit(passivePlayer, FourCC('oC70'), 1920.0, 2432.0, 270.0));
        dummyCreeps.push(new Unit(passivePlayer, FourCC('hC95'), 2048.0, 2432.0, 270.0));
        dummyCreeps.push(new Unit(passivePlayer, FourCC('uC71'), 2176.0, 2432.0, 270.0));
        dummyCreeps.push(new Unit(passivePlayer, FourCC('hC76'), 1664.0, 2304.0, 270.0));
        dummyCreeps.push(new Unit(passivePlayer, FourCC('h03Y'), 1792.0, 2304.0, 270.0));
        dummyCreeps.push(new Unit(passivePlayer, FourCC('h03Z'), 1920.0, 2304.0, 270.0));
        dummyCreeps.push(new Unit(passivePlayer, FourCC('h040'), 2048.0, 2304.0, 270.0));

        for (const creep of dummyCreeps) {
            creep.invulnerable = true;
            creep.paused = true;
        }
        const navyPlayer = MapPlayer.fromIndex(COLOUR.NAVY);

        if(navyPlayer) {
            this.archimondeDummy = new Unit(navyPlayer, FourCC('u000'), 4868.0, -4964.0, 240.0);
            this.archimondeDummy.paused = true;
        ...
        new Unit(passivePlayer, FourCC('n017'), 0.00, -970.00, bj_UNIT_FACING);
        new Unit(passivePlayer, FourCC('n017'), -4400.00, 4737.00, bj_UNIT_FACING);
        new Unit(passivePlayer, FourCC('n017'), 4400.00, 4737.00, bj_UNIT_FACING);
        new Unit(passivePlayer, FourCC('n017'), -2176.00, 700.00, bj_UNIT_FACING);
        new Unit(passivePlayer, FourCC('n017'), 2176.00, 700.00, bj_UNIT_FACING);
        new Unit(passivePlayer, FourCC('n017'), -4400.00, -2500.00, bj_UNIT_FACING);
        new Unit(passivePlayer, FourCC('n017'), 4400.00, -2500.00, bj_UNIT_FACING);
        new Unit(passivePlayer, FourCC('n017'), 1950.00, -3500.00, bj_UNIT_FACING);
        new Unit(passivePlayer, FourCC('n017'), -1950.00, -3500.00, bj_UNIT_FACING);
    ...
    public HealEverythingOnMap(): void {
        const grp: Group = Group.fromHandle(GetUnitsInRectAll(GetPlayableMapRect()!))!;
        grp.for(() => {
