...
export class AdvancedHoloMaze extends AbstractHologramMaze {
    constructor(imagePath: string,
        ...
        this.images = [createImage(imagePath, 192, firstCheckpointX + dist.xDividedBy9, firstCheckpointY + dist.yDividedBy9, 0.00),
            createImage(imagePath, 192, firstCheckpointX - dist.yDividedBy9, firstCheckpointY - dist.xDividedBy9, 0.00),
            createImage(imagePath, 192, firstCheckpointX - dist.xDividedBy9, firstCheckpointY - dist.yDividedBy9, 0.00),
