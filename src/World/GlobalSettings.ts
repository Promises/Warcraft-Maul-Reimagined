...
export class Sounds {
    public static loseALifeSound: Sound = new Sound(
    ...
    public static goldSound: Sound = new Sound(
    ...
    public static victorySound: Sound = new Sound(
    ...
    public static defeatSound: Sound = new Sound(
    ...
    public static impossibleDifficultySound: Sound = new Sound('Sound/Music/mp3Music/PursuitTheme.mp3',
                                                                 false,
                                                                 false,
                                                                 false,
                                                                 10,
...
export function InitializeStaticSounds(): void {
    Sounds.loseALifeSound.setParamsFromLabel('LoadUnload')
    Sounds.loseALifeSound.duration = 740;
    Sounds.goldSound.setParamsFromLabel('ReceiveGold')
    Sounds.goldSound.duration = 589;
    Sounds.goldSound.setChannel(0)
    Sounds.goldSound.setDistances(750.0, 1000.0)
}
...
// export const udg_DamageTypeDebugStr = ['UNKNOWN', undefined, undefined, undefined, 'NORMAL', 'ENHANCED', undefined, undefined, 'FIRE', 'COLD', 'LIGHTNING', 'POISON', 'DISEASE', 'DIVINE', 'MAGIC', 'SONIC', 'ACID', 'FORCE', 'DEATH', 'MIND', 'PLANT', 'DEFENSIVE', 'DEMOLITION', 'SLOW_POISON', 'SPIRIT_LINK', 'SHADOW_STRIKE', 'UNIVERSAL'] as string[];
