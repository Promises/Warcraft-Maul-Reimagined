...
export class GenericAbilityHandler {
    ...
    constructor(game: WarcraftMaul) {
        ...
        this.SetupAbilities();
        this.targetUnitOnEffectAbilitiesTrigger = Trigger.create();
        this.targetUnitOnEffectAbilitiesTrigger.registerAnyUnitEvent(EVENT_PLAYER_UNIT_SPELL_EFFECT);
        this.targetUnitOnEffectAbilitiesTrigger.addAction(() => this.DoTargetUnitOnEffectAbilities());
        this.targetUnitOnCastAbilitiesTrigger = Trigger.create();
        this.targetUnitOnCastAbilitiesTrigger.registerAnyUnitEvent(EVENT_PLAYER_UNIT_SPELL_CAST);
