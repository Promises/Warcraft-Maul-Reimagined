...
export class DamageEngine {
    ...
    private trig: Trigger = Trigger.create();
    private otrg: Trigger = Trigger.create();
    ...
    constructor(damageEngineGlobals: DamageEngineGlobals) {
        ...
        TriggerRegisterAnyUnitEventBJ(this.otrg.handle,EVENT_PLAYER_UNIT_DAMAGED);
        this.otrg.addCondition(Filter(() => this.OnDamage()));

        TriggerRegisterAnyUnitEventBJ(this.trig.handle, EVENT_PLAYER_UNIT_DAMAGING);
        this.trig.addCondition(Filter(() => this.OnPreDamage()));
    }
