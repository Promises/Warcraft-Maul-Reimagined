...
function main()
    SetCameraBounds(-6528.0 + GetCameraMargin(CAMERA_MARGIN_LEFT), -8704.0 + GetCameraMargin(CAMERA_MARGIN_BOTTOM), 6656.0 - GetCameraMargin(CAMERA_MARGIN_RIGHT), 7040.0 - GetCameraMargin(CAMERA_MARGIN_TOP), -6528.0 + GetCameraMargin(CAMERA_MARGIN_LEFT), 7040.0 - GetCameraMargin(CAMERA_MARGIN_TOP), 6656.0 - GetCameraMargin(CAMERA_MARGIN_RIGHT), -8704.0 + GetCameraMargin(CAMERA_MARGIN_BOTTOM))
...
DefineStartLocation(0, -2560.0, 5632.0)
DefineStartLocation(1, 0.0, 4608.0)
DefineStartLocation(2, 4096.0, 5632.0)
DefineStartLocation(3, 5120.0, -512.0)
DefineStartLocation(4, 0.0, 1024.0)
DefineStartLocation(5, -5120.0, -512.0)
DefineStartLocation(6, -4608.0, -4608.0)
DefineStartLocation(7, 4608.0, -4608.0)
DefineStartLocation(8, 0.0, -3584.0)
DefineStartLocation(9, -2560.0, 0.0)
DefineStartLocation(10, 2560.0, 0.0)
DefineStartLocation(11, -5120.0, 3072.0)
DefineStartLocation(12, 5120.0, 3072.0)
DefineStartLocation(13, 0.0, -5888.0)
